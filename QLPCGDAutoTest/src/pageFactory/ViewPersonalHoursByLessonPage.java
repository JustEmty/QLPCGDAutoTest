...
public class ViewPersonalHoursByLessonPage {
	...
	@FindBy(xpath = "//*[@id=\"select2-year-container\"]") private WebElement chooseYear;
	@FindBy(xpath = "/html/body/div[2]/nav/div/div/ul[2]/li/a/i") private WebElement fullAndMinimizeScreenButton;
	
	public ViewPersonalHoursByLessonPage(WebDriver webDriver) {
	...
	public void setYear() throws InterruptedException {
		...
		actions.click(chooseYear).perform();
		Thread.sleep(2000);
